...
/** @var \App\Model\Post[]|\App\Model\PostCar[] $posts */
...
ob_start(); ?>
    ...
    <ul class="index-list">
        <?php foreach ($posts as $post): ?>
            <li>
                <h3><?= $post->getSubject() ?></h3>
                <?php if (method_exists($post, 'getCarModel') && $post->getCarModel()): ?>
                    <p class="car-model">Car model: <?= $post->getCarModel() ?></p>
                <?php endif; ?>
